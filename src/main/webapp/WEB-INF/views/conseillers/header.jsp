...
<spring:url value="/conseillers/add" var="ajoutConseillerUrl" />
<spring:url value="/conseillers" var="listeConseillersUrl" />
<spring:url value="/clients/" var="listeClientsUrl" />
<spring:url value="/comptes" var="listeComptesUrl" />
<spring:url value="/comptescourants" var="listeComptesCourantUrl" />
<spring:url value="/comptesepargnes" var="listeCompteEpargnessUrl" />
		...
		<div id="navbar">
			...
			<ul class="nav navbar-nav navbar-right">
              <li class="active dropdown">
                <a href="${listeConseillersUrl}" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Conseillers<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="${ajoutConseillerUrl}">Nouveau Conseiller</a></li>
                  <li><a href="${listeConseillersUrl}">Lister les conseillers</a></li>
                </ul>
              </li>
              <li class="active dropdown">
              ...
              <li class="active"><a href="${DeconnecteUrl}">Deconnexion</a></li>
